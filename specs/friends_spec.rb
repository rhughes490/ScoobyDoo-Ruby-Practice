...
class TestFriends < MiniTest::Test
  ...
  def test_likes_food__true
     result = likes_to_eat(@person3, "Scooby snacks")
     assert_equal(true, result)
  end

  def test_doesnt_likes_food__false
    result = likes_to_eat(@person4, "Scooby snacks")
 ...
 #refute(likes_to_eat(@person3, "spinach"))
  ...
  def test_delete_friend
    result = delete_friend(@person4, "Velma")
    assert_equal(2, result)
  end
...
def test_favourite_foods
  ...
  expected = ["charcuterie", "soup", "bread", "Scooby snacks", "spagetti", "ratatouille", "spinach"]
